...
enum uade_msgtype {
	...
	UADE_COMMAND_SEND_UADECORE_LOGS,  /* sent from the uadecore */
	UADE_COMMAND_SET_NTSC,
	UADE_COMMAND_SONG_END_NOT_POSSIBLE,
	UADE_COMMAND_FILTER,
	UADE_COMMAND_SET_FREQUENCY,
	UADE_COMMAND_SET_MUTE_MASK,
	UADE_COMMAND_SET_PLAYER_OPTION,
	UADE_COMMAND_SET_RESAMPLING_MODE,
	UADE_COMMAND_SET_WRITE_AUDIO_FD,
	UADE_COMMAND_SET_WRITE_AUDIO_FNAME,
...
#ifdef _MSC_VER
#define UADE_PACK(declaration) __pragma(pack(push, 1)) declaration __pragma(pack(pop))
#else
#define UADE_PACK(declaration) declaration __attribute__((packed))
#endif
